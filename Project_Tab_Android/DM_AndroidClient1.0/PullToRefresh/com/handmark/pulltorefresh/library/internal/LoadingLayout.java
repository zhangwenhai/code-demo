        ...
        ILoadingLayout
{
        ...
        switch (scrollDirection)
        {
            case HORIZONTAL:
                LayoutInflater.from(context)
                        .inflate(R.layout.pull_to_refresh_loading_horizontal,
                                this);
                break;
            case VERTICAL:
            default:
                LayoutInflater.from(context)
                        .inflate(R.layout.pull_to_refresh_loading_vertical,
                                this);
                break;
        }
        
        mInnerLayout = (FrameLayout) findViewById(R.id.pull_to_refresh_inner_layout);
    ...
    /**
     * 
     * get the loading view size<BR>
     * @return return the loading view size
     */
     ...
     * 
     * do on pull<BR>
     * @param scaleOfLayout scaleOfLayout value
     */
    ...
    /**
     * 
     * set Loading Drawable<BR>
     * @param imageDrawable Drawable obj
     * @see com.handmark.pulltorefresh.library.ILoadingLayout#setLoadingDrawable(android.graphics.drawable.Drawable)
     */
