...
public class IndicatorLayout extends FrameLayout implements AnimationListener
{
    ...
    public IndicatorLayout(Context context, PullToRefreshBase.Mode mode)
    {
        ...
        Drawable arrowD = getResources().getDrawable(R.drawable.icon_ptr_indicator_arrow_default);
        ...
        switch (mode)
        {
            case PULL_FROM_END:
                ...
                setBackgroundResource(R.drawable.bg_ptr_indicator_bottom);
            ...
            case PULL_FROM_START:
                ...
                setBackgroundResource(R.drawable.bg_ptr_indicator_top);
                break;
        }
    ...
    /**
     * 
     * check IndicatorLayout is visible<BR>
     * 
     * @return return the indicator layout is visible
     */
