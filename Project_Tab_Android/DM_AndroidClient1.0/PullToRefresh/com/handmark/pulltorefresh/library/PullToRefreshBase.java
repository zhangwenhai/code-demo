 ...
 * @version [Paitao Client V20130911, 2013-10-8]
 */
        ...
        implements IPullToRefresh<T>
{
    ...
    static final int SMOOTH_SCROLL_LONG_DURATION_MS = 325;
    ...
    protected LoadingLayout createLoadingLayout(Context context, Mode mode,
            TypedArray attrs)
    {
        LoadingLayout layout = mLoadingAnimationStyle.createLoadingLayout(context,
                mode,
     ...
     * Allows derivative classes to include any extra LoadingLayouts.<BR>
     * 
     * @param includeStart
     *            whether includeStart
     * @param includeEnd
     *            whether includeEnd
     * @return LoadingLayoutProxy obj
     */
    ...
    protected final void onRestoreInstanceState(Parcelable state)
    {
        if (state instanceof Bundle)
        {
            ...
            mScrollingWhileRefreshingEnabled = bundle.getBoolean(STATE_SCROLLING_REFRESHING_ENABLED,
                    false);
