...
public class ImageLoader
{
    ...
    static final String LOG_LOAD_IMAGE_FROM_MEMORY_CACHE_NOT_EXIST = "Load image from memory cache is not exist [%s]";
            ...
            DisplayImageOptions options, ImageLoadingListener listener)
    {
        ...
        {
            if (configuration.loggingEnabled)
                L.i(LOG_LOAD_IMAGE_FROM_MEMORY_CACHE_NOT_EXIST, memoryCacheKey);
        }
